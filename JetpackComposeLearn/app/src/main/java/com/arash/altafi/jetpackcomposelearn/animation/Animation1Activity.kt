...
fun RotatingSquareComponent() {
    ...
    // modify the composable that its applied to. In this arash.altafi, as the Box composable to
    ...
    Column(
        ...
        content = {
            ...
            // to modify the composable that its applied to. In this arash.altafi, we assign a size
