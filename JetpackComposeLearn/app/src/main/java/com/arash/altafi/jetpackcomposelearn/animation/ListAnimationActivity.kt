package com.arash.altafi.jetpackcomposelearn.animation
...
fun ListAnimationComponent(personList: List<Person>) {
    ...
    // composable that its applied to. In this arash.altafi, we configure the LazyColumn to
    ...
    LazyColumn(
        ...
        itemsIndexed(items = personList,
            itemContent = { index, person ->
                ...
                // or exit. In the arash.altafi below, since I also added functionality to delete an item, I
