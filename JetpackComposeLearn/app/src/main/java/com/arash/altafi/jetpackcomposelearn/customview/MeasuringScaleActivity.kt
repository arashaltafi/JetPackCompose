package com.arash.altafi.jetpackcomposelearn.customview
...
fun ScaleLineComponent(index: Int) {
    ...
    // You can think of Modifiers as implementations of the decorators pattern that are
    // used to modify the composable that its applied to. In this arash.altafi, we add background 
...
fun ScaleCenterPointer() {
    ...
    Column {
        ...
        // You can think of Modifiers as implementations of the decorators pattern that are
        // used to modify the composable that its applied to. In this arash.altafi, we give it a 
