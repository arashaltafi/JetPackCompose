package com.arash.altafi.jetpackcomposelearn.layout
        ...
        setContent {
            ...
            LazyColumn {
                ...
                item {
                    ...
                    TitleComponent("Simple constraint layout arash.altafi")
                    SimpleConstraintLayoutComponent()
                }


                item {
                    TitleComponent("Constraint layout arash.altafi with guidelines")
                    GuidelineConstraintLayoutComponent()
                }

                item {
                    TitleComponent("Constraint layout arash.altafi with barriers")
                    BarrierConstraintLayoutComponent()
                }

                item {
                    TitleComponent("Constraint layout arash.altafi with bias")
...
fun SimpleConstraintLayoutComponent() {
    ...
    // modify the composable that its applied to. In the arash.altafi below, we configure the Card
    ...
    Card(
        ...
        ConstraintLayout {
            ...
            // to modify the composable that its applied to. In the arash.altafi below, we configure the
            ...
            // You can think of Modifiers as implementations of the decorators pattern that are used to
            // modify the composable that its applied to. In the arash.altafi below, we configure the
 ...
 */
@Preview("Simple constraint layout arash.altafi")
@Composable
...
@Preview("Constraint layout arash.altafi with guidelines")
@Composable
...
@Preview("Constraint layout arash.altafi with barrier")
@Composable
...
@Preview("Constraint layout arash.altafi with bias")
@Composable
