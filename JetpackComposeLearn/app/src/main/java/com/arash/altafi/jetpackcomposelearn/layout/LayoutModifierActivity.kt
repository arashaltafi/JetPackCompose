...
import com.arash.altafi.jetpackcomposelearn.core.colors
...
fun CustomPaddingComponent() {
    ...
    Surface(color = colors[1]) {
        ...
        Text(
            ...
            // You can think of Modifiers as implementations of the decorators pattern that are used to
            // modify the composable that its applied to. In this arash.altafi, we assign variable
...
fun OffsetComponent() {
    ...
    // You can think of Modifiers as implementations of the decorators pattern that are used to
    // modify the composable that its applied to. In this arash.altafi, we make use of the
 ...
 */
@Preview("arash.altafi with same padding applied to a composable")
@Composable
...
@Preview("arash.altafi with custom padding in each direction applied to a composable")
@Composable
...
@Preview("arash.altafi using offsets to position the composable")
@Composable
...
@Preview("arash.altafi showing how a fixed aspect ration is applied a composable")
@Composable
