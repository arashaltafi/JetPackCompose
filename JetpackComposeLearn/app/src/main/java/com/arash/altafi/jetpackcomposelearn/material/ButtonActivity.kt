package com.arash.altafi.jetpackcomposelearn.material
...
fun RoundedCornerButtonComponent() {
    ...
    Button(
        onClick = {},
        modifier = Modifier.padding(16.dp),
        // Provide a custom shape for this button. In this arash.altafi. we specify the button to have
 ...
 */
@Preview("arash.altafi showing a simple button")
@Composable
...
@Preview("arash.altafi showing a button with border")
@Composable
...
@Preview("arash.altafi showing a button with corners")
@Composable
...
@Preview("arash.altafi showing a outline button")
@Composable
...
@Preview("arash.altafi showing a text button")
@Composable
