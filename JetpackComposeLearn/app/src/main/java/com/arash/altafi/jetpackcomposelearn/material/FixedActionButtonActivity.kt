...
fun ScaffoldWithBottomBarAndCutout() {
    ...
    // that explicitly.
    Scaffold(
        topBar = { TopAppBar(title = { Text("Scaffold arash.altafis") }) },
        bottomBar = {
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                // you don't specify a theme (this arash.altafi doesn't specify a theme either hence
                // it will just use defaults. Look at DarkModeActivity if you want to see an
                // arash.altafi of using themes.
 ...
 */
@Preview("Fixed Aaction Button arash.altafi")
@Composable
