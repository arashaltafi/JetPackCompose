...
fun MaterialCardComponent() {
    ...
    // modify the composable that its applied to. In the arash.altafi below, we add a padding of
...
fun MaterialDiscreteSliderComponent() {
    ...
    Card(shape = RoundedCornerShape(4.dp), modifier = Modifier.padding(8.dp)) {
        ...
        // Design specification. In this arash.altafi, we create a discrete slider with fixed steps.
        Slider(
            value = sliderValue,
            valueRange = 0f..10f,
            steps = 4,
