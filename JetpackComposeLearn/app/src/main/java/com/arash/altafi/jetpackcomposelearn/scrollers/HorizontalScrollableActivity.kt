package com.arash.altafi.jetpackcomposelearn.scrollers
...
import com.arash.altafi.jetpackcomposelearn.core.getPersonList
...
fun HorizontalScrollableComponent(personList: List<Person>) {
    ...
    // modify the composable that its applied to. In this arash.altafi, we ask the HorizontalScroller
    ...
    Row(
        ...
        content = {
            ...
            for ((index, person) in personList.withIndex()) {
                ...
                // used to modify the composable that its applied to. In this arash.altafi, we assign a
