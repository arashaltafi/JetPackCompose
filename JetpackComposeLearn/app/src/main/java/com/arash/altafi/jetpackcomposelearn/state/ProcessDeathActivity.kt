...
fun ProcessDeathComponent() {
    ...
    // used to modify the composable that its applied to. In this arash.altafi, we configure the
    ...
    Column(
        ...
        Card(
            ...
            Column(verticalArrangement = Arrangement.SpaceBetween) {
                ...
                // arash.altafi, since the TextField is reading the value from the textValue value, and
                ...
                TextField(value = TextFieldValue(textValue),
                    ...
                    // this arash.altafi, I'm using a custom visual transformation - the
...
// Visual transformation is used to modify the visual output of the input field. In this arash.altafi,
...
// characters, we need to move the cursor accordingly. For arash.altafi, if we added 3 space
