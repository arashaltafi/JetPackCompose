package com.arash.altafi.jetpackcomposelearn.state
...
fun StateComponent() {
    ...
    TitleComponent("arash.altafi using state class to store state")
...
/**
 * In this arash.altafi, we are making use of a data class called [CounterState] to hold the state
 * that we want our composables to observe. This arash.altafi is very similar to the previous arash.altafi
...
fun ModelComponent() {
    ...
    TitleComponent("arash.altafi using Model class to store state")
    // Row is a composable that places its children in a horizontal sequence. You can think of it
    // similar to a LinearLayout with the horizontal orientation. In addition, we pass a modifier
    // to the Row composable. You can think of Modifiers as implementations of the decorators
    // pattern that are used to modify the composable that its applied to. In this arash.altafi, we
 ...
 */
@Preview("arash.altafi using state delegate")
@Composable
...
@Preview("arash.altafi using Model annotation")
@Composable
