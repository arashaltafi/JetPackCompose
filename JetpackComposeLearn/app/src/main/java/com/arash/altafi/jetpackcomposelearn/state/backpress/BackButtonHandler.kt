package com.arash.altafi.jetpackcomposelearn.state.backpress
...
// a composition, without having to pass the value in. Some other arash.altafis of Providers and 
...
internal fun handler(
    ...
    // arash.altafi below, it initializes the value of ComposableBackHandler() and does it only during 
