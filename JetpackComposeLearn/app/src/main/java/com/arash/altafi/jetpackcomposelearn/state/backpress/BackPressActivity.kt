...
class BackPressActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            // composition. In the arash.altafi below, it initializes the value of AppState() and does
...
fun Screen1(appState: AppState) {
    ...
    // modify the composable that its applied to. In this arash.altafi, as the Column composable to
