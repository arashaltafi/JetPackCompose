...
import com.arash.altafi.jetpackcomposelearn.image.NetworkImageComponentPicasso

class LiveDataActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // Just initialized the view model that we want to use in this arash.altafi. Ideally, we would
...
fun LiveDataComponent(personListLiveData: LiveData<List<Person>>) {
    ...
    // needs to shows vs hidden based on which branch of code is being executed. In this arash.altafi,
