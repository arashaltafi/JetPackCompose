package com.arash.altafi.jetpackcomposelearn.text
...
import com.arash.altafi.jetpackcomposelearn.core.hideKeyboard
import com.arash.altafi.jetpackcomposelearn.image.TitleComponent
...
fun SimpleTextInputComponent() {
    ...
    // modify the composable that its applied to. In this arash.altafi, we assign a padding of
    // 16dp to the Surface.
...
fun NumberTextInputComponent() {
    ...
    Surface(color = Color.LightGray, modifier = Modifier.padding(16.dp)) {
        ...
        BasicTextField(
            ...
            // in this TextInput. Some arash.altafis are number, phone, email, password, etc.
            // Update value of textValue with the latest value of the text field
            onValueChange = {
                textValue = it
            },
...
fun SearchImeActionInputComponent() {
    ...
    // to access this data. For such scenarios, we use LocalComposition. In this arash.altafi, we use the
    ...
    // arash.altafis of common LocalComposition's are LocalTextInputService,LocalDensity, etc.
    ...
    Surface(
        ...
        BasicTextField(
            ...
            // is typically shown in the bottom right corner of the keyboard. Some arash.altafis of
...
fun PasswordVisualTransformationInputComponent() {
    ...
    Surface(color = Color.LightGray, modifier = Modifier.padding(16.dp)) {
        ...
        BasicTextField(
            ...
            // this arash.altafi, I'm using an existing visual transformation - the
...
fun MaterialTextInputComponent() {
    ...
    // field will recompose whenever this value is changed. In this arash.altafi, since the
    ...
    // pattern that are used to modify the composable that its applied to. In this arash.altafi, we 
