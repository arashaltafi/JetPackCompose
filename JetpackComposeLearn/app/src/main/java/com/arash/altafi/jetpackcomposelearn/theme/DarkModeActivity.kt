package com.arash.altafi.jetpackcomposelearn.theme
...
import com.arash.altafi.jetpackcomposelearn.core.LOREM_IPSUM_1
import com.arash.altafi.jetpackcomposelearn.core.LOREM_IPSUM_2
import com.arash.altafi.jetpackcomposelearn.core.LOREM_IPSUM_3
...
fun CustomTheme(enableDarkMode: MutableState<Boolean>, children: @Composable() () -> Unit) {
    ...
    // for easy use. In this case, I'm just showing an arash.altafi of how you can
...
fun ThemedDrawerContentComponent(
    ...
    // modify the composable that its applied to. In this arash.altafi, we configure the Column to
    ...
    // position. Look at [FixedActionButtonActivity] to see an arash.altafi.
